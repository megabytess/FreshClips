...
class BSReceiverChatroomPage extends StatefulWidget {
  const BSReceiverChatroomPage({
    super.key,
  ...
  @override
  State<BSReceiverChatroomPage> createState() => _BSReceiverChatroomPageState();
}

class _BSReceiverChatroomPageState extends State<BSReceiverChatroomPage> {
  ...
  void initState() {
    ...
    print('message fetched: $chatRoomId');
  }

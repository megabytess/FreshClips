...
class ClientChatroomMessagePage extends StatefulWidget {
  const ClientChatroomMessagePage({
    super.key,
  ...
  @override
  State<ClientChatroomMessagePage> createState() =>
      _ClientChatroomMessagePageState();
}

class _ClientChatroomMessagePageState extends State<ClientChatroomMessagePage> {
  ...
  void initState() {
    ...
    debugPrint('Messages that are fetched from: $chatRoomId');
  }
      ...
      appBar: AppBar(
        ...
        title: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('chatRooms')
              .where('receiverEmail', isEqualTo: widget.receiverEmail)
              .snapshots(),
          builder: (context, snapshot) {
            ...
            String accountImage = userData['receiverImageUrl'] ?? '';
            String accountName = userData['receiverUsername'] ?? 'Unknown';
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String senderImageUrl = messageData['senderImageUrl'] ?? '';

...
import 'package:freshclips_capstone/features/hairstylist-features/views/bottomnav_bar/settings_drawer/manage_availability/edit_availability_page.dart';
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              ' ${dayData['status'] == true ? 'AVAILABLE' : 'NOT AVAILABLE'}',
                                              style: GoogleFonts.poppins(
                                                fontSize: screenWidth * 0.04,
                                                fontWeight: FontWeight.w700,
                                                color: const Color.fromARGB(
